<template>
  <div class="dashboard">
    ...
    <div>
      ...
      <ul>
        <li v-for="outcome in outcomes" :key="outcome.address">
            <OutcomeItem :name="outcome.name" :address="outcome.address"></OutcomeItem>
        </li><br>
        <br>
        <br>
      </ul>
...
export default {
  ...
  methods: {
    ...
    addOrder: function(signedOrder) {
      this.$refs.orderlist.addSignedOrder(signedOrder)
    },
